...
@property (nonatomic, copy) NSString *urlAk;
...
@property (nonatomic, copy) NSString *skipTime;//开屏广告跳过时长
...
@property (nonatomic, assign) BOOL isHiddenVoiceButton;//控制视频的音量控制按钮是否展示（默认显示）
...
@property (nonatomic, copy) NSString *canReceiveClickEvent; // 视频能否点击跳转； 1: 是；0：否，默认1     仅自渲染支持
