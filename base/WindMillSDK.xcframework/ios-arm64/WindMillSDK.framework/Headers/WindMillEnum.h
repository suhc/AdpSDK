...
typedef enum : NSUInteger {
    WindMillAdSlotTypeNone = 0,  //未知
    WindMillAdSlotTypeRewardVideo=1,  //激励
    WindMillAdSlotTypeSplash=2,  //开屏
    WindMillAdSlotTypeIntersititial=4,  //插屏
    WindMillAdSlotTypeNative=5,  //原生
    WindMillAdSlotTypeBanner=7,  //banner
} WindMillAdSlotType;
...
typedef enum : NSInteger {
    ...
    WindMillAdnJADYun = 40,         // 京媒
    WindMillAdnOctopus = 41,        // 章鱼
    WindMillAdnMercury = 42,        // 倍业
...
typedef enum : NSUInteger  {
    WindMillInteractionTypeCustom = 0,
...
typedef NS_ENUM(NSInteger, WindMillAdOrientation) {
    WindMillAdOrientationPortrait, // 竖屏模式
    WindMillAdOrientationLandscape // 横屏模式
};
