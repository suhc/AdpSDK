...
///   - error: 具体错误信息
-(void)onSplashAdLoadFail:(WindMillSplashAd *)splashAd error:(NSError *_Nullable)error;

/// 广告即将曝光回调
/// - Parameter splashAd: WindMillSplashAd 实例对象
-(void)onSplashAdWillPresentScreen:(WindMillSplashAd *)splashAd;
...
///   - splashAd: WindMillSplashAd 实例对象
///   - error: 具体错误信息
-(void)onSplashAdFailToPresent:(WindMillSplashAd *)splashAd withError:(NSError *_Nullable)error;
...
///   - splashAd: WindMillSplashAd 实例对象
///   - adInfo: 具体错误信息
- (void)splashAd:(WindMillSplashAd *)splashAd didFailBidADSource:(WindMillAdInfo *)adInfo error:(NSError *_Nullable)error;
...
///   - splashAd: WindMillSplashAd 实例对象
///   - error: 具体错误信息
- (void)splashAd:(WindMillSplashAd *)splashAd didFailToLoadADSource:(WindMillAdInfo *)adInfo error:(NSError *_Nullable)error;
...
/// 广告代理对象
@property (nonatomic, weak, nullable) id<WindMillSplashAdDelegate> delegate;
